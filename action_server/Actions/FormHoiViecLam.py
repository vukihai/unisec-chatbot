...
class FormHoiViecLam(UnisecForm):
   def name(self):
      return "form_hoi_viec_lam"
   ...
   def submit(self, dispatcher, tracker, domain):
      ...
      if entity_nganh_hoc_validated != None:   
         ...
         try:
            ...
            res = dt['job']
            dispatcher.utter_message("sau đây là thông tin về cơ hội việc làm của " + entity_nganh_hoc)
            dispatcher.utter_message(res)
         except:
             dispatcher.utter_message("không tìm thấy thông tin về cơ hội việc làm ngành " + entity_nganh_hoc)
