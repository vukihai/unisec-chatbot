...
class FormHoiDiemChuan(UnisecForm):
   ...
   def required_slots(self, tracker):
      if len(self.getResponse(tracker)[1]) < 20:
         return []
   ...
   def validate_entity_truong_dai_hoc(self, value, dispatcher, tracker, domain):
       val = UnisecValidator.getInstance().validate_uni(value)
       print("vukihai")
       print(val)
       if val[0] > 0.35:
           return {'entity_truong_dai_hoc': val[1]}
       else:
           return {'entity_truong_dai_hoc': None}
